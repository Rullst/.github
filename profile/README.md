...
> [v12 release program](https://github.com/Rullst/Rullst/blob/main/docs/src/v12.md) and
> [compatibility policy](https://github.com/Rullst/Rullst/blob/main/docs/src/compatibility-policy.md).
...
<p align="center">
  ...
  <a href="https://github.com/Rullst/Rullst/blob/main/docs/src/compatibility-policy.md"><img src="https://img.shields.io/badge/MSRV-1.96.0-f74c00?logo=rust" alt="MSRV 1.96.0"></a>
</p>

<p align="center">
  <strong>From your first typed route to data, identity, AI and product workflows.<br>One coordinated Rust toolchain. Your application stays yours.</strong>
</p>

<p align="center">
  <a href="https://github.com/Rullst/Rullst/blob/main/docs/src/start-here.md"><strong>Start building</strong></a>
  ·
  ...
  ·
  <a href="https://github.com/Rullst/Rullst/blob/main/docs/src/why-Rullst.md"><strong>Why Rullst?</strong></a>
</p>
...
**Choose your first path:** [Create an application with the CLI](https://github.com/Rullst/Rullst/blob/main/docs/src/1-getting-started.md)
· [Build a JSON API](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/rest-api-quickstart.md)
· [Explore the ecosystem](#the-rullst-ecosystem)
· [Review the current audit](https://github.com/Rullst/Rullst/blob/main/docs/src/v12-release-audit.md)
...
| **Declared MSRV** | [![MSRV 1.96.0](https://img.shields.io/badge/MSRV-1.96.0-f74c00?style=flat-square&logo=rust)](https://github.com/Rullst/Rullst/blob/main/docs/src/compatibility-policy.md) | Every publishable v12 manifest declares Rust 1.96.0 and CI runs an explicit workspace all-feature check with that toolchain. |
...
and coding agents. Read the complete [history and design philosophy](https://github.com/Rullst/Rullst/blob/main/docs/src/philosophy.md).
...
> 📖 **[Build your first Rullst application with the Zero-to-Hero tutorial](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/01-hello-world.md)**
>
> 🌐 **[Create and verify your first JSON REST API](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/rest-api-quickstart.md)**
> includes a complete `main.rs`, secure-header middleware, the run command,
> and a `curl` request.

Prefer scaffolding? Follow the [v12 CLI installation guide](https://github.com/Rullst/Rullst/blob/main/docs/src/1-getting-started.md)
...
[Omni tutorial](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/43-omni-web-first.md) and
[offline-sync tutorial](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/44-omni-offline-sync.md).
...
[assisted upgrade tutorial](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/36-assisted-framework-upgrades.md)
and the [v5 → v12 guide](https://github.com/Rullst/Rullst/blob/main/docs/src/migration-v5-to-v12.md).
...
🔑 **[Maintainer GitHub CLI installation & safe login](https://github.com/Rullst/Rullst/blob/main/docs/src/gh-install.md)**
...
| :--- | :--- | :--- |
| Follow the [Zero-to-Hero tutorial](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/01-hello-world.md), then report the first point of friction. | Read the [contribution guide](https://github.com/Rullst/Rullst/blob/main/CONTRIBUTING.md), choose a bounded issue, and include evidence with the change. | Review the [capability ledger](https://github.com/Rullst/Rullst/blob/main/docs/src/capability-ledger.md), join [Discord](https://discord.gg/2ntKFtsSjw), and challenge roadmap assumptions with a concrete use case. |
...
- **Development build tuning:** generated configuration may select an installed
  `mold` or `lld`. `cargo rullst dev` and `dash` rebuild and restart an owned
  application process, with a same-origin browser refresh after generation
  readiness. Failed builds keep the current application running; process-local
  state resets on restart. Observed reload time depends on the host and project.
...
[benchmarking methodology](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/35-high-performance-benchmarking.md)
...
- 🌐 **Guarded AI client:** supported Gemini, Claude, OpenAI, DeepSeek,
  ...
  injection heuristics, PII masking, opt-in bounded streaming/cancellation,
  authenticated audit export and adaptive evaluation reports without raw
  model content. Passing a heuristic or offline evaluation is not authorization
...
### 🌐 Web-first, with explicit frontend boundaries

The v12 wizard generates server-rendered `html!` pages enhanced with HTMX, or
a headless JSON API from the Blank starter. It does **not** offer equivalent
generated profiles for every lower-level frontend foundation below.

| Mode | Runtime model | Important boundary |
| :--- | :--- | :--- |
| HTMX SSR | The public v12 HTML scaffold | Generated projects serve a pinned local HTMX asset; there is no required project-local SPA build. HTMX is still a browser dependency. |
| LiveView | Application-owned WebSocket UI foundation | Not a public v12 scaffold profile; lifecycle, origin, backpressure and reconnect behavior need integration tests. |
| Wasm Islands | Application-owned client WebAssembly | Not an equivalent generator profile; measure bundle size and browser compatibility per application. |
| Pico.css / Tera | Styling / file-template foundations | Not selectable v12 profiles. Applications own rendering, asset and escaping integration. |
...
- **Typed Server Functions:** One concrete async Rust signature generates an
  ...
  [server-functions tutorial](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/52-typed-server-functions.md).
...
technical differentiators, read [Why Rullst?](https://github.com/Rullst/Rullst/blob/main/docs/src/why-Rullst.md).
...
- 💾 **[rullst-orm](https://github.com/Rullst/Rullst/tree/main/rullst-orm)**: Active Record, durable opt-in outbox, Scout, pgvector, bounded Qdrant and namespaced Redis structures for SQLite/PostgreSQL/MySQL/MariaDB, a bounded Turso-primary blank/API profile, and capability APIs for MongoDB, DuckDB and SurrealDB; applications still own tenant predicates and database policy. See [Polyglot Persistence](https://github.com/Rullst/Rullst/blob/main/docs/src/polyglot-persistence.md), [Transactional Outbox](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/38-transactional-outbox.md), [Scout Search](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/39-scout-search.md) and [RAG/Vector Search](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/22-rag-vector-search.md).
...
- 🤖 **[rullst-ai](https://github.com/Rullst/Rullst/tree/main/rullst-ai)**: Guarded provider-agnostic clients (Gemini, OpenAI, Claude, DeepSeek, Ollama), a capability-declared OpenAI-compatible local/cloud adapter, bounded SSE/cancellation, tenant-aware audited RAG, HMAC-authenticated audit export, content-free adaptive evaluation reports, structured output, and authorized local-tool foundations. See [Tenant-Bound RAG](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/41-tenant-bound-rag.md).
...
- 📨 **[rullst-messaging](https://github.com/Rullst/Rullst/tree/main/rullst-messaging)**: Versioned bounded envelopes, topic-scoped idempotent publication, consumer-group fan-out, expiring ACK leases, retry/DLQ, a canonical envelope codec, allowlisted W3C trace context, a deterministic process-local broker and durable local SQLite with an explicit AES-256-GCM header/payload profile. Metadata remains visible and the codec is not a transport; remote Kafka/RabbitMQ/Redis Streams/NATS/cloud adapters remain roadmap work. See [Bounded Brokered Messaging](https://github.com/Rullst/Rullst/blob/main/docs/src/tutorials/49-brokered-messaging.md).
...
[Start building](https://github.com/Rullst/Rullst/blob/main/docs/src/1-getting-started.md) ·
